...
| Supavisor | v2.9.13 noted but DEFERRED (see `supavisor-deferral.md`) | https://github.com/supabase/supavisor/releases/tag/v2.9.13 |
...
SHA into every artifact manifest. PgBouncer pin: download the versioned
