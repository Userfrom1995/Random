...
- **Updated:** 2026-08-22 (maintainer run 32544088499, EVENT `created` on PR #118 ~01:40Z). Fresh survey confirms: PR #118 has a genuine `continue` build IN FLIGHT (`32544081395`, head `7fe10e0`, B5.20, 11.119 bpp). PR #119 still stale/conflicting (target #98 already CLOSED; workflow-file push wall). No merge (M3 < 8.71 unmet).
...
## IN FLIGHT
- **Prism M1-M4 (issue #117, PR #118, branch `opencode/117-prism-m1-m4-optimization`):** optimization loop. Head `7fe10e0` (B5.20, 11.119 bpp, byte-exact, harness ~160s). As of run 32544088499 a `continue` build IS in flight (run `32544081395`, `in_progress`, started 01:39:49Z). A duplicate owner `/oc continue` (01:39:47Z) queued run `32544088481` (`pending`) - trails behind, harmless. No duplicate `continue` dispatched.
