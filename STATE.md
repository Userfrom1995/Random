# STATE - Random factory checkpoint
 - **Updated:** 2026-09-08T11:51Z (maintainer run 34222870291 event created on PR #295, plus live resurvey to 1d2c3669)
 - **Action this run:** `[]` - standby, Fixer for 2 harness findings at 1d2c3669 already in_progress (34222621627 + pending 34222870307), awaiting push beyond 1d2c3669 before Reviewer re-gate
 ...
 - **Branch retention:** `opencode/issue294-20260907194528` at `1d2c3669` OPEN PR #295 (Reviewer block 1d2c3669 2 findings: ledger garbage-header + length_sweep baseline ckpt, Fixer in_progress, ledger 25 rows Refs #294)
 - **Build guard:** 1 open PR [295 MERGEABLE head 1d2c3669 base cdf3cdae CLEAN (Reviewer block 1d2c3669 2 findings pending Fixer)], `gh issue list --state open` = [42 brainstorm, 70 lab-health, 294 Post-Transformer] (3 open). No duplicate dispatch while Fixer in_progress.
---

## STANDING OWNER DIRECTIVES (active)
 - **POST-TRANSFORMER CHALLENGE (2026-09-07T16:35:36Z, supreme, via #42) - AMENDED 2026-09-07T21:23:19Z via #294:** O(T^2)-free architecture must beat/match Causal Transformer under matched param budget on 4 gates: (1) associative recall & tracking, (2) length generalization 4x-8x, (3) BPB on Enwik8, (4) **Inference Footprint - Pareto dominance**: asymptotic proof (no hidden T) + state-bytes and ms/token vs T 1k..32k. Tiers: (a) full O(1) flat within 5% 1k->32k; (b) conditional sublinear/subquadratic dominating baseline at every T with G1+G2+G3 green counts as `G4-tier-b` keep-worthy. Research track single-PR #295 Refs #294 until all gates pass; issue #294 OPEN; M1+M2-toy+M3+M4a+M4b+M4c-M4y+M4ab at bec0d248 (Reviewer dcc6da02 + Tester bec0d248 284+6 hostile, ledger 25 rows Refs #294) + verification a7c8d0dd + Fixer 1d2c3669 blocked at 1d2c3669 (2 findings, Fixer dispatched) - next S-tiny GPU gates.
...
## NEXT-RUN PLAYBOOK
 1. Await Fixer push beyond 1d2c3669 (2 findings: ledger by_scale guard + length_sweep baseline ckpt) via opencode 34222621627/34222870307.
...
## ISSUES
 ...
 - **#294 Post-Transformer** - OPEN research+architect+M1+M2-toy+M3+M4a+M4b+M4c-M4y+M4ab at bec0d248 Reviewer+Tester gated + verification a7c8d0dd + Fixer 1d2c3669 blocked at 1d2c3669 (2 findings, Fixer in_progress 34222621627), S-tiny GPU gates next
