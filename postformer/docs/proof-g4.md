...
- p1-toy, timed `step()` path, decode-steps 50, warmup 10:
  ...
  (growth 0.4%, bar is <5%: PASS toy-only, NOT a gate result), bytes flat 24576 (PASS toy-only, NOT a gate result).
- p5-toy: T=1024 -> 1.051ms / 40960 B; T=32768 -> 1.053ms / 40960 B (PASS toy-only, NOT a gate result).
