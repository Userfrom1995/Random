...
- [~] B5 Predictor bank + residual-DIFF context (M1: < PNG 13.05, < WebP 9.61) - see `architecture-m1-m4.md` Section 2. **IN PROGRESS: 11.437 summed beats PNG but not WebP (delta 1.83); now 176 contexts (ResDiff+activity), Rice+ResDiff+color+per-plane pred landed, CFL landed but sum-abs shows no gain, weighted 75/25 still MED wins.**
