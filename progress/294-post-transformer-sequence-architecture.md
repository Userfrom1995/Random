...
- **Current step:** M4ac verification complete at 2c2fa587 (ledger 25 rows green, py_compile clean, scope clean, NOT orphan with merge-base cdf3cdae after --unshallow, PR MERGEABLE CLEAN per gh, forward_chunk refs only test self-pins, Refs #294; full pytest incl. M4ac suite rests on the torch-env Tester pass). Next: S-tiny full gates on a GPU runner.
