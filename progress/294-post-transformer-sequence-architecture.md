...
- **Active Milestone:** M4d A6-vocab toy pilot complete on PR #295 (M1 + M2-toy + M3 + M4a/M4b toy falsification + A4 sweep gated, A6 pilot measured); next is S-tiny full gates (GPU-blocked).
...
- **Current step:** M4d A6 vocab-stress pilot complete (p1 + transformer at vocab512, both at 0.0 floor, budget below threshold, H1/H5 open). Next: S-tiny full gates on a GPU runner.
