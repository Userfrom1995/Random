...
- **Current step:** M4ah verification complete at c7cc1c55 (ledger 25 rows green 26-col schema, py_compile clean, scope clean, NOT orphan with merge-base cdf3cdae after --unshallow, PR MERGEABLE CLEAN per gh, forward_chunk refs only test self-pins, Refs #294; full pytest incl. M4ah suite rests on the torch-env Tester pass). Next: S-tiny full gates on a GPU runner.
