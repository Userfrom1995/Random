...
- **Active Milestone:** M4b complete on PR #295 (M1 + M2-toy + M3 + M4a/M4b toy falsification gated); next is S-tiny full gates (GPU-blocked).
...
- **Current step:** M4b P4-vs-P1 toy probes complete (H4 negative at toy, honestly ledgered). Next: S-tiny full gates on a GPU runner.
