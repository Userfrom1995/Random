...
- **Current step:** M4bb verification complete at d29474bb (ledger 25 rows green 26-col schema, py_compile clean, scope clean, NOT orphan with merge-base cdf3cdae after --unshallow, PR MERGEABLE per gh, forward_chunk refs only test self-pins, Refs #294; full pytest incl. M4bb suite rests on the torch-env Tester pass). Next: S-tiny full gates on a GPU runner.
