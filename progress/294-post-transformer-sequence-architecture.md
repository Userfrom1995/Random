...
- **Active Milestone:** M4e toy envelope audit plus M4q-M4ab Tester hardening complete on PR #295 (M1 + M2-toy + M3 + M4a/M4b toy falsification + A4 sweep + A6 pilot + audit + M4q/M4r/M4s/M4t/M4u/M4v/M4w/M4x/M4y/M4z/M4aa/M4ab hostile suites gated-ready, ledger 25 rows green); next is S-tiny full gates (GPU-blocked).
...
- **Current step:** M4z-M4ab verification complete at bec0d248 (ledger 25 rows green, py_compile clean, scope clean, NOT orphan with merge-base cdf3cdae, PR MERGEABLE CLEAN per gh, forward_chunk refs only test self-pins, Refs #294; full pytest incl. M4z/M4aa/M4ab suites rests on the torch-env Tester pass). Next: S-tiny full gates on a GPU runner.
