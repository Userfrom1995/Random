...
- **Current step:** M4m verification complete on torch CPU (175 passed, ledger 25 rows green, py_compile clean, scope clean, merge-base cdf3cdae NOT orphan after --unshallow, zero forward_chunk refs, Refs #294). Next: S-tiny full gates on a GPU runner.
