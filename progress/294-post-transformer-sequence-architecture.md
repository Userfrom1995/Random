...
- **Active Milestone:** M4c A4-slots mini-milestone complete on PR #295 (M1 + M2-toy + M3 + M4a/M4b toy falsification gated, A4 toy sweep measured); next is S-tiny full gates (GPU-blocked).
...
- **Current step:** M4c A4 slots sweep complete (G0 0.04625 / G4=G16=G64 0.0825 at toy; slot count ceiling identified, H2 open). Next: S-tiny full gates on a GPU runner.
