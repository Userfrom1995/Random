...
Every result table ends with a `- Dr. Ada, the Researcher`-style attribution
of the codec version, and links the issue and the PR. Benchmark rows live in
`obsidian/benchmarks/` and are reviewed as part of each PR.
